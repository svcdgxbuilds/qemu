...
/**
 * struct iommu_user_intel_vtd - Intel VT-d specific config for stage1
 *
 ...
 *     | hwpt_type           |     parent_id                         |
 *     +---------------------+---------------------------------------+
 *     | IOMMU_USER_HWPT_S2  |     ioas_id                           |
 *     +---------------------+---------------------------------------+
 *     | IOMMU_USER_HWPT_S1  |     Stage-2 hwpt_id                   |
 *     +=====================+=======================================+
...
struct iommu_alloc_user_hwpt {
	__u32 size;
#define IOMMU_USER_FLAG_NESTING		(1 << 0)
	__u32 flags;
	__u32 dev_id;
	__u32 hwpt_type;
	__u32 parent_id;
